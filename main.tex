...
\newcommand{\hans}{\textcolor{darkred}}
...
\hans{Hans can add comments using \textbackslash hans\{...\}}

\begin{itemize}
 \item  \hyperlink{todo1}{Task 7 (section 8) needs work - expand briefly on 2.7}
 %\item \hyperlink{todo2}{Include the ROC'n'Roll appendix}
 \item  \hyperlink{todo3}{Additional pieces on a delay-differential framework are less developed but conducted under mydas and could perhaps be included in an additional work section}
 \item \href{https://drive.google.com/open?id=1ldTJfrVxNsIHD9s9W0jyNaeedLZqDIPS}{Delay-difference}
 \item \href{https://drive.google.com/open?id=1ba_mw6bhLKfLrT5Pn_gXCXuPFoseYVxd}{RAM Recruitment}
\end{itemize}
...
\begin{itemize}[labelindent=\parindent,noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt]
 ...
 \end{itemize}
 \item \textbf{Outcome} The data were collated into a PostgreSQL database \hyperref[appendix:db]{database} and \hyperref[appendix:code]{summarised}, using \href{https://drive.google.com/file/d/15Lb1Npyi-cOIPCLWbR4YrNWkAZuEyc1X/view?usp=sharing}{R code}.
 %\coilin{[make link live]} developed for processing. 
 \begin{itemize}
    \item At the end of the project the data were archived on \href{https://drive.google.com/open?id=1bilqGhV1-JzEsPW_vQBkz65GwdjIsaky}{google drive}.
 \end{itemize}
\end{itemize}
...
\newpage\section{Data Collation}\label{sec:data}
\input{include/task2.tex}

\newpage\section{Assessment Methods}\label{sec:methods}
\input{include/task3.tex}

\newpage\section{Framework}\label{sec:framework}
\input{include/task4.tex}   

\newpage\section{Simulations}\label{sec:sims}
\input{include/task5.tex}

\newpage\section{Liason and Linkage}\label{sec:link}
\coilin{[Expand briefly on section 2.7]}
\input{include/task6.tex}

\hypertarget{todo1}{\todo{Task 7 (section 8) needs work - expand briefly on 2.7}}
...
\subsection{Dataset Summary}\label{appendix:code}

\includepdf[pages=-,pagecommand={},width=\textwidth]{include/dataSmry.pdf}

\subsection{Recruitment spectral decomposition}\label{appendix:spectral}

\includepdf[pages=-,pagecommand={},width=\textwidth]{include/mydas_recruitment.pdf}
...
A peer review paper is being prepared, the results can be found in a \href{https://3o2y9wugzp1kfxr5hvzgzq-on.drv.tw/MyDas/papers/roc/roc.html}{vignette} and the \href{https://drive.google.com/open?id=1tVApe-tfO2tRBGy_HN-Pubc4wmQtjDdE}{analysis} is on google drive.


\subsubsection{Pareto}

A peer review paper is being prepared, the results can be found in a \href{https://3o2y9wugzp1kfxr5hvzgzq-on.drv.tw/MyDas/papers/pareto/pareto.html}{vignette} and the \href{https://drive.google.com/open?id=1B33OKH5UTFyi99S-jD1J-1fsrtMBE5WG}{analysis} is on google drive.

%\includepdf[pages=-,pagecommand={},width=\textwidth]{include/pareto.pdf}


\subsubsection{Delay Difference}

\hypertarget{todo3}{\todo{Additional pieces on a delay-differential framework are less developed but conducted under mydas and could perhaps be included in an additional work section}}
