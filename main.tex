...
\includepdf[pages=1-2]{include/BiodiversityTemplate_MYDAS_first.pdf}
%%stock.assesment.org
...
\begin{itemize}[labelindent=\parindent,noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt]
 ...
 \begin{itemize}
    \item At the end of the project the data were taken offline and archived on \href{https://drive.google.com/open?id=1bilqGhV1-JzEsPW_vQBkz65GwdjIsaky}{google drive}.
 \end{itemize}
\end{itemize}
...
\subsubsection{Delay Differential}
Additional pieces on a delay-differential framework are less developed but could be used to screen the dynamics of potential HCRs analytically. Towards this goal under MyDas, a continuous harvest control rule to mimic that of the current ICES framework and phase-plane analyses of coupled biomass-effort systems were derived and presented here.
\includepdf[pages=-,pagecommand={},width=\textwidth]{include/cHCR.pdf}
\includepdf[pages=-,pagecommand={},width=\textwidth]{include/equilibria.pdf}

\end{appendices}

\includepdf[pages=1-2]{include/BiodiversityTemplate_MYDAS_last.pdf}
\end{document}
